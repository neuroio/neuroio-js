...
interface NeuroioWsApiV1SettingsInterface {
  token?: string;
...
export interface NeuroioWsApiV1Interface extends EventEmitterInterface {
...
class NeuroioWsApiV1 extends EventEmitter implements NeuroioWsApiV1Interface {
  ...
  constructor({
    ...
    apiEndpoints,
    endpoint,
  }: NeuroioWsApiV1SettingsInterface) {
    super();
